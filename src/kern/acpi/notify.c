...
void
uacpi_deinitialize_notify (void)
{
...
static void
free_notification_ctx (struct notification_ctx *ctx)
{
...
uacpi_status
uacpi_notify_all (uacpi_namespace_node *node, uacpi_u64 value)
{
	uacpi_status ret;
...
uacpi_status
uacpi_install_notify_handler (uacpi_namespace_node *node,
...
uacpi_status
uacpi_uninstall_notify_handler (uacpi_namespace_node *node,
																uacpi_notify_handler handler)
{
	uacpi_status ret;
	uacpi_object *obj;
