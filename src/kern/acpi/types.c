...
const uacpi_char *
uacpi_object_type_to_string (uacpi_object_type type)
{
	switch (type)
		{
...
static uacpi_bool
buffer_alloc (uacpi_object *obj, uacpi_size initial_size)
{
	uacpi_buffer *buf;
...
static uacpi_bool
empty_buffer_or_string_alloc (uacpi_object *object)
{
	return buffer_alloc (object, 0);
}

uacpi_bool
uacpi_package_fill (uacpi_package *pkg, uacpi_size num_elements,
...
static uacpi_bool
package_alloc (uacpi_object *obj, uacpi_size initial_size,
...
static uacpi_bool
empty_package_alloc (uacpi_object *object)
{
	return package_alloc (object, 0, UACPI_PREALLOC_OBJECTS_NO);
}

uacpi_mutex *
uacpi_create_mutex (void)
{
	uacpi_mutex *mutex;
...
static uacpi_bool
op_region_alloc (uacpi_object *obj)
{
...
static uacpi_bool
field_unit_alloc (uacpi_object *obj)
{
...
static uacpi_bool
processor_alloc (uacpi_object *obj)
{
...
static uacpi_bool
thermal_zone_alloc (uacpi_object *obj)
{
...
uacpi_object *
uacpi_create_object (uacpi_object_type type)
{
	uacpi_object *ret;
	object_ctor ctor;
...
static void
free_buffer (uacpi_handle handle)
{
...
static uacpi_bool
free_queue_push (struct free_queue *queue, uacpi_package *pkg)
{
	uacpi_package **slot;
...
static void
free_plain_no_recurse (uacpi_object *obj, struct free_queue *queue)
{
	switch (obj->type)
		{
		case UACPI_OBJECT_PACKAGE:
...
static void
unref_plain_no_recurse (uacpi_object *obj, struct free_queue *queue)
{
...
static void
unref_chain_no_recurse (uacpi_object *obj, struct free_queue *queue)
{
...
static void
unref_object_no_recurse (uacpi_object *obj, struct free_queue *queue)
{
	if (obj->type == UACPI_OBJECT_REFERENCE)
		{
...
static void
free_package (uacpi_handle handle)
{
...
static void
free_mutex (uacpi_handle handle)
{
...
void
uacpi_mutex_unref (uacpi_mutex *mutex)
{
	if (mutex == UACPI_NULL)
		return;
...
static void
free_event (uacpi_handle handle)
{
...
static void
free_address_space_handler (uacpi_handle handle)
{
...
static void
free_address_space_handlers (uacpi_address_space_handler *handler)
{
...
static void
free_device_notify_handlers (uacpi_device_notify_handler *handler)
{
...
static void
free_handlers (uacpi_handle handle)
{
...
void
uacpi_address_space_handler_unref (uacpi_address_space_handler *handler)
{
	uacpi_shareable_unref_and_delete_if_last (handler,
																						free_address_space_handler);
}
...
static void
free_op_region (uacpi_handle handle)
{
...
static void
free_device (uacpi_handle handle)
{
...
static void
free_processor (uacpi_handle handle)
{
...
static void
free_thermal_zone (uacpi_handle handle)
{
...
static void
free_field_unit (uacpi_handle handle)
{
...
static void
free_method (uacpi_handle handle)
{
...
void
uacpi_method_unref (uacpi_control_method *method)
{
	uacpi_shareable_unref_and_delete_if_last (method, free_method);
}

static void
free_object_storage (uacpi_object *obj)
{
	switch (obj->type)
		{
		case UACPI_OBJECT_STRING:
...
static void
make_chain_bugged (uacpi_object *obj)
{
...
void
uacpi_object_ref (uacpi_object *obj)
{
	while (obj)
		{
...
void
uacpi_object_unref (uacpi_object *obj)
{
...
static uacpi_status
buffer_alloc_and_store (uacpi_object *obj, uacpi_size buf_size,
...
static uacpi_status
assign_buffer (uacpi_object *dst, uacpi_object *src,
...
static uacpi_bool
pkg_copy_reqs_push (struct pkg_copy_reqs *reqs, uacpi_object *dst,
										uacpi_package *pkg)
{
...
static uacpi_status
deep_copy_package_no_recurse (uacpi_object *dst, uacpi_package *src,
...
static uacpi_status
deep_copy_package (uacpi_object *dst, uacpi_object *src)
{
...
static uacpi_status
assign_mutex (uacpi_object *dst, uacpi_object *src,
							enum uacpi_assign_behavior behavior)
{
...
static uacpi_status
assign_event (uacpi_object *dst, uacpi_object *src,
							enum uacpi_assign_behavior behavior)
{
	if (behavior == UACPI_ASSIGN_BEHAVIOR_DEEP_COPY)
		{
...
static uacpi_status
assign_package (uacpi_object *dst, uacpi_object *src,
								enum uacpi_assign_behavior behavior)
{
	if (behavior == UACPI_ASSIGN_BEHAVIOR_SHALLOW_COPY)
		{
...
void
uacpi_object_attach_child (uacpi_object *parent, uacpi_object *child)
{
...
void
uacpi_object_detach_child (uacpi_object *parent)
{
...
uacpi_object_type
uacpi_object_get_type (uacpi_object *obj)
{
	return obj->type;
}

uacpi_object_type_bits
uacpi_object_get_type_bit (uacpi_object *obj)
{
	return (1u << obj->type);
}

uacpi_bool
uacpi_object_is (uacpi_object *obj, uacpi_object_type type)
{
	return obj->type == type;
}

uacpi_bool
uacpi_object_is_one_of (uacpi_object *obj, uacpi_object_type_bits type_mask)
{
...
uacpi_status
uacpi_object_get_integer (uacpi_object *obj, uacpi_u64 *out)
{
...
uacpi_status
uacpi_object_assign_integer (uacpi_object *obj, uacpi_u64 value)
{
...
void
uacpi_buffer_to_view (uacpi_buffer *buf, uacpi_data_view *out_view)
{
...
static uacpi_status
uacpi_object_do_get_string_or_buffer (uacpi_object *obj, uacpi_data_view *out,
																			uacpi_u32 mask)
{
...
uacpi_status
uacpi_object_get_string_or_buffer (uacpi_object *obj, uacpi_data_view *out)
{
...
uacpi_status
uacpi_object_get_string (uacpi_object *obj, uacpi_data_view *out)
{
...
uacpi_status
uacpi_object_get_buffer (uacpi_object *obj, uacpi_data_view *out)
{
	return uacpi_object_do_get_string_or_buffer (obj, out,
...
uacpi_bool
uacpi_object_is_aml_namepath (uacpi_object *obj)
{
...
static uacpi_status
uacpi_object_do_assign_buffer (uacpi_object *obj, uacpi_data_view in,
															 uacpi_object_type type)
{
	...
	ret = uacpi_object_assign (obj, &tmp_obj,
...
uacpi_status
uacpi_object_assign_string (uacpi_object *obj, uacpi_data_view in)
{
	return uacpi_object_do_assign_buffer (obj, in, UACPI_OBJECT_STRING);
}

uacpi_status
uacpi_object_assign_buffer (uacpi_object *obj, uacpi_data_view in)
{
	return uacpi_object_do_assign_buffer (obj, in, UACPI_OBJECT_BUFFER);
}

uacpi_object *
uacpi_object_create_uninitialized (void)
{
	return uacpi_create_object (UACPI_OBJECT_UNINITIALIZED);
}

uacpi_status
uacpi_object_create_integer_safe (uacpi_u64 value,
...
uacpi_object *
uacpi_object_create_integer (uacpi_u64 value)
{
	uacpi_object *obj;
...
uacpi_object *
uacpi_object_create_string (uacpi_data_view view)
{
	return uacpi_object_do_create_string_or_buffer (view, UACPI_OBJECT_STRING);
}

uacpi_object *
uacpi_object_create_buffer (uacpi_data_view view)
{
	return uacpi_object_do_create_string_or_buffer (view, UACPI_OBJECT_BUFFER);
}

uacpi_object *
uacpi_object_create_cstring (const uacpi_char *str)
{
...
uacpi_status
uacpi_object_get_package (uacpi_object *obj, uacpi_object_array *out)
{
...
uacpi_object *
uacpi_object_create_reference (uacpi_object *child)
{
	uacpi_object *obj;
...
uacpi_status
uacpi_object_assign_reference (uacpi_object *obj, uacpi_object *child)
{
	uacpi_status ret;
	uacpi_object object = { 0 };
...
uacpi_status
uacpi_object_get_dereferenced (uacpi_object *obj, uacpi_object **out)
{
...
uacpi_status
uacpi_object_get_processor_info (uacpi_object *obj, uacpi_processor_info *out)
{
...
uacpi_status
uacpi_object_assign_package (uacpi_object *obj, uacpi_object_array in)
{
	uacpi_status ret;
	uacpi_size i;
...
uacpi_object *
uacpi_object_create_package (uacpi_object_array in)
{
	uacpi_status ret;
	uacpi_object *obj;
...
uacpi_status
uacpi_object_assign (uacpi_object *dst, uacpi_object *src,
										 enum uacpi_assign_behavior behavior)
{
	uacpi_status ret = UACPI_STATUS_OK;
...
uacpi_object *
uacpi_unwrap_internal_reference (uacpi_object *object)
{
	for (;;)
		{
