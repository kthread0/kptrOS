...
find_pci_root (uacpi_namespace_node *node)
{
...
static uacpi_status
pci_region_attach (uacpi_region_attach_data *data)
{
...
static uacpi_status
pci_region_detach (uacpi_region_detach_data *data)
{
...
static uacpi_status
pci_region_do_rw (uacpi_region_op op, uacpi_region_rw_data *data)
{
...
static uacpi_status
handle_pci_region (uacpi_region_op op, uacpi_handle op_data)
{
	switch (op)
		{
...
static uacpi_status
memory_region_attach (uacpi_region_attach_data *data)
{
...
static uacpi_status
memory_region_detach (uacpi_region_detach_data *data)
{
...
static uacpi_status
io_region_attach (uacpi_region_attach_data *data)
{
...
static uacpi_status
io_region_detach (uacpi_region_detach_data *data)
{
...
static uacpi_status
memory_region_do_rw (uacpi_region_op op, uacpi_region_rw_data *data)
{
	struct memory_region_ctx *ctx = data->region_context;
	uacpi_size offset;
...
static uacpi_status
handle_memory_region (uacpi_region_op op, uacpi_handle op_data)
{
	switch (op)
		{
		case UACPI_REGION_OP_ATTACH:
...
static uacpi_status
table_data_region_do_rw (uacpi_region_op op, uacpi_region_rw_data *data)
{
...
static uacpi_status
handle_table_data_region (uacpi_region_op op, uacpi_handle op_data)
{
	switch (op)
		{
		case UACPI_REGION_OP_ATTACH:
...
static uacpi_status
io_region_do_rw (uacpi_region_op op, uacpi_region_rw_data *data)
{
	struct io_region_ctx *ctx = data->region_context;
	uacpi_u8 width;
	uacpi_size offset;
...
static uacpi_status
handle_io_region (uacpi_region_op op, uacpi_handle op_data)
{
	switch (op)
		{
		case UACPI_REGION_OP_ATTACH:
...
void
uacpi_install_default_address_space_handlers (void)
{
