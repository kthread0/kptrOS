...
void
uacpi_shareable_init (uacpi_handle handle)
{
...
uacpi_bool
uacpi_bugged_shareable (uacpi_handle handle)
{
	struct uacpi_shareable *shareable = handle;
...
void
uacpi_make_shareable_bugged (uacpi_handle handle)
{
	struct uacpi_shareable *shareable = handle;
...
uacpi_u32
uacpi_shareable_ref (uacpi_handle handle)
{
	struct uacpi_shareable *shareable = handle;
...
uacpi_u32
uacpi_shareable_unref (uacpi_handle handle)
{
	struct uacpi_shareable *shareable = handle;
...
void
uacpi_shareable_unref_and_delete_if_last (uacpi_handle handle,
...
uacpi_u32
uacpi_shareable_refcount (uacpi_handle handle)
{
	struct uacpi_shareable *shareable = handle;
