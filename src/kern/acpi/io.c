...
uacpi_size
uacpi_round_up_bits_to_bytes (uacpi_size bit_length)
{
	return UACPI_ALIGN_UP (bit_length, 8, uacpi_size) / 8;
}

static void
cut_misaligned_tail (uacpi_u8 *data, uacpi_size offset, uacpi_u32 bit_length)
{
...
static uacpi_size
bit_span_offset (struct bit_span *span, uacpi_size bits)
{
...
static void
bit_copy (struct bit_span *dst, struct bit_span *src)
{
...
static void
do_misaligned_buffer_read (const uacpi_buffer_field *field, uacpi_u8 *dst)
{
...
void
uacpi_read_buffer_field (const uacpi_buffer_field *field, void *dst)
{
...
static void
do_write_misaligned_buffer_field (uacpi_buffer_field *field, const void *src,
																	uacpi_size size)
{
	struct bit_span src_span = { 0 };
	struct bit_span dst_span = { 0 };
...
void
uacpi_write_buffer_field (uacpi_buffer_field *field, const void *src,
													uacpi_size size)
{
	if (!(field->bit_index & 7))
		{
...
static uacpi_status
access_field_unit (uacpi_field_unit *field, uacpi_u32 offset,
...
static uacpi_status
wtr_buffer_size (uacpi_field_unit *field, uacpi_address_space space,
								 uacpi_size *out_size)
{
	switch (space)
		{
...
static uacpi_status
handle_special_field (uacpi_field_unit *field, uacpi_data_view buf,
...
static uacpi_status
do_read_misaligned_field_unit (uacpi_field_unit *field, uacpi_u8 *dst,
															 uacpi_size size)
{
	uacpi_status ret;
	...
	reads_to_do = UACPI_ALIGN_UP (field->bit_offset_within_first_byte
																		+ field->bit_length,
...
uacpi_status
uacpi_read_field_unit (uacpi_field_unit *field, void *dst, uacpi_size size,
...
static uacpi_status
write_generic_field_unit (uacpi_field_unit *field, const void *src,
													uacpi_size size)
{
	uacpi_status ret;
	...
	while (bits_left)
		{
			...
			ret = access_field_unit (field, byte_offset, UACPI_REGION_OP_WRITE,
															 data);
			if (uacpi_unlikely_error (ret))
				return ret;
...
uacpi_status
uacpi_write_field_unit (uacpi_field_unit *field, const void *src,
												uacpi_size size, uacpi_data_view *wtr_response)
{
	uacpi_status ret;
	uacpi_bool did_handle;
	uacpi_data_view data_view = { 0 };
...
uacpi_status
uacpi_field_unit_get_read_type (struct uacpi_field_unit *field,
...
uacpi_status
uacpi_field_unit_get_bit_length (struct uacpi_field_unit *field,
...
static uacpi_u8
gas_get_access_bit_width (const struct acpi_gas *gas)
{
	/*
...
static uacpi_status
gas_validate (const struct acpi_gas *gas, uacpi_u8 *access_bit_width,
							uacpi_u8 *bit_width)
{
 ...
 */
uacpi_status
uacpi_gas_read_mapped (const uacpi_mapped_gas *gas, uacpi_u64 *out_value)
{
	uacpi_status ret;
...
uacpi_status
uacpi_gas_write_mapped (const uacpi_mapped_gas *gas, uacpi_u64 in_value)
{
	uacpi_status ret;
	uacpi_u8 access_byte_width;
	uacpi_u8 bit_offset, bits_left, index = 0;
...
static void
unmap_gas_io (uacpi_handle io_handle, uacpi_size size)
{
	UACPI_UNUSED (size);
...
uacpi_status
uacpi_map_gas_noalloc (const struct acpi_gas *gas,
...
uacpi_status
uacpi_map_gas (const struct acpi_gas *gas, uacpi_mapped_gas **out_mapped)
{
	uacpi_status ret;
...
void
uacpi_unmap_gas_nofree (uacpi_mapped_gas *gas)
{
	gas->unmap (gas->mapping, gas->access_bit_width / 8);
}

void
uacpi_unmap_gas (uacpi_mapped_gas *gas)
{
...
uacpi_status
uacpi_gas_read (const struct acpi_gas *gas, uacpi_u64 *out_value)
{
	uacpi_status ret;
	uacpi_mapped_gas mapping;
...
uacpi_status
uacpi_gas_write (const struct acpi_gas *gas, uacpi_u64 in_value)
{
	uacpi_status ret;
	uacpi_mapped_gas mapping;
...
uacpi_status
uacpi_system_memory_read (void *ptr, uacpi_size offset, uacpi_u8 width,
													uacpi_u64 *out)
{
...
uacpi_status
uacpi_system_memory_write (void *ptr, uacpi_size offset, uacpi_u8 width,
													 uacpi_u64 in)
{
	ptr = UACPI_PTR_ADD (ptr, offset);
...
uacpi_status
uacpi_system_io_read (uacpi_handle handle, uacpi_size offset, uacpi_u8 width,
											uacpi_u64 *out)
{
	uacpi_status ret;
...
uacpi_status
uacpi_system_io_write (uacpi_handle handle, uacpi_size offset, uacpi_u8 width,
											 uacpi_u64 in)
{
	uacpi_status ret;
...
uacpi_status
uacpi_pci_read (uacpi_handle handle, uacpi_size offset, uacpi_u8 width,
								uacpi_u64 *out)
{
	uacpi_status ret;
	union integer_data data = {
...
uacpi_status
uacpi_pci_write (uacpi_handle handle, uacpi_size offset, uacpi_u8 width,
								 uacpi_u64 in)
{
	uacpi_status ret;
