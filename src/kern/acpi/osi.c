...
uacpi_status
uacpi_initialize_interfaces (void)
{
	uacpi_size i;
...
void
uacpi_deinitialize_interfaces (void)
{
...
uacpi_latest_queried_vendor_interface (void)
{
...
uacpi_status
uacpi_install_interface (const uacpi_char *name, uacpi_interface_kind kind)
{
...
uacpi_status
uacpi_uninstall_interface (const uacpi_char *name)
{
...
static uacpi_status
configure_host_interface (uacpi_host_interface type, uacpi_bool enabled)
{
	struct registered_interface *interface;
	uacpi_status ret;
...
uacpi_status
uacpi_enable_host_interface (uacpi_host_interface type)
{
	return configure_host_interface (type, UACPI_TRUE);
}

uacpi_status
uacpi_disable_host_interface (uacpi_host_interface type)
{
...
uacpi_status
uacpi_bulk_configure_interfaces (uacpi_interface_action action,
...
uacpi_status
uacpi_handle_osi (const uacpi_char *string, uacpi_bool *out_value)
{
	uacpi_status ret;
	struct registered_interface *interface;
