...
static void
namespace_node_detach_object (uacpi_namespace_node *node)
{
	uacpi_object *object;
...
static void
free_namespace_node (uacpi_handle handle)
{
...
uacpi_status
uacpi_initialize_namespace (void)
{
...
void
uacpi_deinitialize_namespace (void)
{
	uacpi_status ret;
...
uacpi_namespace_node *
uacpi_namespace_node_alloc (uacpi_object_name name)
{
...
void
uacpi_namespace_node_unref (uacpi_namespace_node *node)
{
	uacpi_shareable_unref_and_delete_if_last (node, free_namespace_node);
}

uacpi_status
uacpi_namespace_node_install (uacpi_namespace_node *parent,
															uacpi_namespace_node *node)
{
...
uacpi_bool
uacpi_namespace_node_is_alias (uacpi_namespace_node *node)
{
	return node->flags & UACPI_NAMESPACE_NODE_FLAG_ALIAS;
}

uacpi_bool
uacpi_namespace_node_is_dangling (uacpi_namespace_node *node)
{
	return node->flags & UACPI_NAMESPACE_NODE_FLAG_DANGLING;
}

uacpi_bool
uacpi_namespace_node_is_temporary (uacpi_namespace_node *node)
{
	return node->flags & UACPI_NAMESPACE_NODE_FLAG_TEMPORARY;
}

uacpi_bool
uacpi_namespace_node_is_predefined (uacpi_namespace_node *node)
{
	return node->flags & UACPI_NAMESPACE_NODE_PREDEFINED;
}

uacpi_status
uacpi_namespace_node_uninstall (uacpi_namespace_node *node)
{
...
static uacpi_object_name
segment_to_name (const uacpi_char **string, uacpi_size *in_out_size)
{
...
uacpi_status
uacpi_namespace_node_find (uacpi_namespace_node *parent,
...
static uacpi_status
object_mutate_refcount (uacpi_object *obj, void (*cb) (uacpi_object *))
{
	uacpi_status ret = UACPI_STATUS_OK;
...
uacpi_status
uacpi_namespace_node_reacquire_object (uacpi_object *obj)
{
	return object_mutate_refcount (obj, uacpi_object_ref);
}

uacpi_status
uacpi_namespace_node_release_object (uacpi_object *obj)
{
	return object_mutate_refcount (obj, uacpi_object_unref);
}

uacpi_object_name
uacpi_namespace_node_name (const uacpi_namespace_node *node)
{
	return node->name;
}
...
uacpi_status
uacpi_namespace_node_type (const uacpi_namespace_node *node,
													 uacpi_object_type *out_type)
{
	uacpi_status ret;
...
uacpi_status
uacpi_namespace_node_is_one_of (const uacpi_namespace_node *node,
																uacpi_object_type_bits type_mask,
																uacpi_bool *out)
{
	uacpi_status ret;
...
uacpi_status
uacpi_namespace_node_is (const uacpi_namespace_node *node,
...
uacpi_status
uacpi_namespace_node_next_typed (uacpi_namespace_node *parent,
...
uacpi_status
uacpi_namespace_node_next (uacpi_namespace_node *parent,
													 uacpi_namespace_node **iter)
{
...
uacpi_size
uacpi_namespace_node_depth (const uacpi_namespace_node *node)
{
	uacpi_size depth = 0;
...
uacpi_namespace_node *
uacpi_namespace_node_parent (uacpi_namespace_node *node)
{
	return node->parent;
}
	...
	while (node != uacpi_namespace_root ())
		{
			...
			uacpi_memcpy (&path[offset], node->name.text,
...
void
uacpi_free_absolute_path (const uacpi_char *path)
{
