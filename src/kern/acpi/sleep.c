...
#ifndef UACPI_REDUCED_HARDWARE
uacpi_status
uacpi_set_waking_vector (uacpi_phys_addr addr32, uacpi_phys_addr addr64)
{
...
static uacpi_status
enter_sleep_state_hw_full (uacpi_u8 state)
{
	uacpi_status ret;
...
static uacpi_status
prepare_for_wake_from_sleep_state_hw_full (uacpi_u8 state)
{
	uacpi_status ret;
	uacpi_u64 pm1a, pm1b;
	UACPI_UNUSED (state);
...
static uacpi_status
wake_from_sleep_state_hw_full (uacpi_u8 state)
{
	uacpi_status ret;
...
static uacpi_status
get_slp_type_for_state (uacpi_u8 state, uacpi_u8 *a, uacpi_u8 *b)
{
	uacpi_char path[] = "_S0";
	uacpi_status ret;
...
static uacpi_status
eval_sleep_helper (uacpi_namespace_node *parent, const uacpi_char *path,
									 uacpi_u8 value)
{
	uacpi_object *arg;
...
static uacpi_status
eval_sst_for_state (enum uacpi_sleep_state state)
{
	uacpi_u8 arg;
...
uacpi_status
uacpi_prepare_for_sleep_state (enum uacpi_sleep_state state_enum)
{
...
static uacpi_u8
make_hw_reduced_sleep_control (uacpi_u8 slp_typ)
{
	uacpi_u8 value;
...
static uacpi_status
enter_sleep_state_hw_reduced (uacpi_u8 state)
{
	uacpi_status ret;
...
static uacpi_status
wake_from_sleep_state_hw_reduced (uacpi_u8 state)
{
	g_uacpi_rt_ctx.last_sleep_typ_a = UACPI_SLEEP_TYP_INVALID;
	g_uacpi_rt_ctx.last_sleep_typ_b = UACPI_SLEEP_TYP_INVALID;
...
uacpi_status
uacpi_enter_sleep_state (enum uacpi_sleep_state state_enum)
{
	uacpi_u8 state = state_enum;
...
uacpi_status
uacpi_wake_from_sleep_state (uacpi_sleep_state state_enum)
{
	uacpi_u8 state = state_enum;
