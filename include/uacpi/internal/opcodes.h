...
#define UACPI_INTERNAL_OP(code) UACPI_OP(Internal_##code, code, 0, { UACPI_PARSE_OP_UNREACHABLE })

#define UACPI_BAD_OPCODE(code) UACPI_OP(Reserved_##code, code, 0, { UACPI_PARSE_OP_BAD_OPCODE })

#define UACPI_METHOD_CALL_OPCODE(nargs)                                   \
	UACPI_OP(InternalOpMethodCall##nargs##Args,                             \
					 0xF7 + nargs,                                                  \
...
#define UACPI_UNRESOLVED_NAME_STRING_OP(character, code)                                             \
	UACPI_OP(UACPI_InternalOpUnresolvedNameString_##character,                                         \
					 code,                                                                                     \
...
#define UACPI_ENUMERATE_OPCODES                                                                       \
	...
	UACPI_OP(InternalOpReadFieldAsBuffer,                                                               \
					 0xF4,                                                                                      \
					 UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                   \
					 {                                                                                          \
													 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                         \
	...
	UACPI_OP(InternalOpReadFieldAsInteger,                                                              \
					 0xF5,                                                                                      \
					 UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                   \
					 {                                                                                          \
													 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                         \
	...
	UACPI_OP(InternalOpNamedObject,                                                                     \
					 0xF6,                                                                                      \
					 UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG | \
...
#define UACPI_ENUMERATE_EXT_OPCODES                                                                                      \
	...
	UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(                                                                                     \
									...
									1)                                                                                                     \
	UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(                                                                                     \
									PowerRes, 0x84, UACPI_OBJECT_POWER_RESOURCE, UACPI_PARSE_OP_LOAD_IMM, 1, UACPI_PARSE_OP_LOAD_IMM, 2)   \
	UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(ThermalZone, 0x85, UACPI_OBJECT_THERMAL_ZONE)                                        \
	UACPI_OUT_OF_LINE_OP(IndexFieldOp, UACPI_EXT_OP(0x86), uacpi_index_field_op_decode_ops, UACPI_OP_PROPERTY_OUT_OF_LINE) \
	UACPI_OUT_OF_LINE_OP(BankFieldOp, UACPI_EXT_OP(0x87), uacpi_bank_field_op_decode_ops, UACPI_OP_PROPERTY_OUT_OF_LINE)   \
	UACPI_OP(DataRegionOp,                                                                                                 \
					 UACPI_EXT_OP(0x88),                                                                                           \
					 0,                                                                                                            \
					 {                                                                                                             \
													 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                             \
